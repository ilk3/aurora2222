      ...
      >
        <div className="p-6">
          ...
          <div className="space-y-6">
            <Link
              to="/"
              className="block text-xl font-medium text-text-primary hover:text-primary transition-colors duration-200"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              {t('nav.home')}
            </Link>
            ...
            <div className="space-y-4">
              <p className="text-xl font-medium text-text-primary">{t('nav.company')}</p>
              <div className="pl-4 space-y-4">
                <Link
                  to="/about"
                  className="block text-lg text-text-primary hover:text-primary transition-colors duration-200"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  {t('nav.about')}
                </Link>
            ...
            <div className="pt-4 border-t">
              <div className="flex items-center space-x-4">
                ...
                <button
                  ...
                  className="text-lg text-text-primary hover:text-primary transition-colors duration-200"
                >
                  English
                </button>
