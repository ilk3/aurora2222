...
export function Timeline() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Calculate progress based on the active year marker position
      ...
      yearElements.forEach((el, index) => {
        ...
        if (markerMiddle <= viewportMiddle) {
          ...
          // Calculate fine-grained progress between years
        ...
        <div className="relative grid grid-cols-4 md:grid-cols-10">
          ...
          <div className="col-span-1 md:col-span-3 relative">
            ...
            <div className="absolute top-0 right-4 md:right-12 w-1 md:w-1.5 h-full bg-white/80 rounded-full pointer-events-none">
              ...
              <div 
                className="absolute top-0 left-0 w-full rounded-full origin-top transition-transform duration-75 ease-out bg-gradient-to-b from-[#A42D53] via-[#C14B6E] to-[#E85D50]"
                style={{ 
                  height: '100%',
            ...
            <div className="sticky top-1/2 -translate-y-1/2 pr-8 md:pr-24 z-10">
              <div className="text-right">
                <div className="text-3xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary-purple">
                  {activeYear}
                </div>
              </div>
            </div>
          ...
          <div ref={timelineRef} className="col-span-3 md:col-span-7 relative pl-4 md:pl-8">
            ...
            <div className="relative">
              {timelineEvents.map((event, index) => (
                <div
                  key={event.year}
                  className="year-marker mb-[30vh] last:mb-0"
                >
                  {/* Event content */}
                  <RevealOnScroll
                    animation="fade"
                    ...
                    <div className="relative">
                      ...
                      <div className={`transform transition-all duration-500 ${
                        ...
                        <div className="backdrop-blur-md bg-white/10 rounded-2xl md:rounded-3xl p-4 md:p-8 border border-white/20 hover:shadow-xl transition-all duration-300">
                          <h3 className="text-lg md:text-2xl font-bold text-text-primary mb-2 md:mb-4">{event.title}</h3>
